                     ...
                     completion:^(BOOL finished){
                         ...
                         if(strongSelf){
                             if(strongSelf.alpha == 0.0f || strongSelf.hudView.alpha == 0.0f){
                                 ...
                                 //SPLog(@"%@", [UIApplication sharedApplication].windows);
                                 //SPLog(@"keyWindow = %@", [UIApplication sharedApplication].keyWindow);
                             }
                         }
                     }];
}
...
- (UIColor*)foregroundColorForStyle{
    if(self.style == SVProgressHUDStyleLight){
        // frank liu
        return [UIColor colorWithRed:7/255.0 green:67/255.0 blue:86/255.0 alpha:1.0];
