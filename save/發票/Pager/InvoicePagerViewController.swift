...
class InvoicePagerViewController: DTPagerController {
    ...
    init() {
        ...
        let vc1 = ScanProductViewController(nibName:"ScanProductViewController", bundle: nil)
        let nav1 = UINavigationController(rootViewController: vc1)
        vcAry.append(nav1)
        
        let vc2 = ScanInvoiceViewController(nibName: "ScanInvoiceViewController", bundle: nil)
        let nav2 = UINavigationController(rootViewController: vc2)
        vcAry.append(nav2)
        
        titleAry.append("商品條碼搜尋")
        titleAry.append("電子發票掃描")
