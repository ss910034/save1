...
class SellTabHomeTableViewController: UITabBarController, UITabBarControllerDelegate {
...
//        tabBar.addSubview(bgView)
        ...
        let tabTwo = SellDetailViewController(nibName: "SellDetailViewController", bundle: nil)
